...
public class InitData implements CommandLineRunner{
    ...
    public void run(String... args)throws Exception{
        ...
        info.setStartingTime(new Date("Mon May 04 09:00:00 GMT+0800 2024")); //NOSONAR
        info.setEndTime(new Date("Mon May 04 15:51:52 GMT+0800 2024")); //NOSONAR
        ...
        info.setStationsId(suzhou);
        info.setTerminalStationId(taiyuan);
        info.setStartingTime(new Date("Mon May 04 12:00:00 GMT+0800 2024")); //NOSONAR
        info.setEndTime(new Date("Mon May 04 17:51:52 GMT+0800 2024")); //NOSONAR
        service.create(info,null);
        ...
        info.setStationsId(suzhou);
        info.setTerminalStationId(taiyuan);
        info.setStartingTime(new Date("Mon May 04 14:00:00 GMT+0800 2024")); //NOSONAR
        info.setEndTime(new Date("Mon May 04 20:51:52 GMT+0800 2024")); //NOSONAR
        service.create(info,null);
        ...
        info.setStationsId(suzhou);
        info.setTerminalStationId(taiyuan);
        info.setStartingTime(new Date("Mon May 04 08:00:00 GMT+0800 2024")); //NOSONAR
        info.setEndTime(new Date("Mon May 04 17:21:52 GMT+0800 2024")); //NOSONAR
        service.create(info,null);
        ...
        info.setStationsId(suzhou);
        info.setTerminalStationId(taiyuan);
        info.setStartingTime(new Date("Mon May 04 07:00:00 GMT+0800 2024")); //NOSONAR
        info.setEndTime(new Date("Mon May 04 19:59:52 GMT+0800 2024")); //NOSONAR
        service.create(info,null);
    }
}
