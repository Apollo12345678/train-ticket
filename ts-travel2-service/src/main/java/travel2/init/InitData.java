...
public class InitData implements CommandLineRunner {
    ...
    public void run(String... args)throws Exception{
        ...
        info.setStartingTime(new Date("Mon May 04 09:51:52 GMT+0800 2024")); //NOSONAR
        ...
        info.setStationsId(nanjing);
        info.setTerminalStationId(beijing);
        info.setStartingTime(new Date("Mon May 04 11:31:52 GMT+0800 2024")); //NOSONAR
        ...
        info.setStationsId(nanjing);
        info.setTerminalStationId(beijing);
        info.setStartingTime(new Date("Mon May 04 7:05:52 GMT+0800 2024")); //NOSONAR
        info.setEndTime(new Date("Mon May 04 12:51:52 GMT+0800 2024")); //NOSONAR
        service.create(info,null);
        ...
        info.setStationsId(nanjing);
        info.setTerminalStationId(beijing);
        info.setStartingTime(new Date("Mon May 04 08:31:52 GMT+0800 2024")); //NOSONAR
        ...
        info.setStationsId(nanjing);
        info.setTerminalStationId(beijing);
        info.setStartingTime(new Date("Mon May 04 07:51:52 GMT+0800 2024")); //NOSONAR
